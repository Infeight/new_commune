...
const MyPosts = () => {
  ...
  const deletepost = async( e)=>{
   ...
   document.getElementById('home').style.opacity = '100%'
      await fetch('https://commune1.onrender.com/delpost',{method:'post',headers:{'Content-Type':'application/json'},body:JSON.stringify(del_id_det)})
   })
...
// }
  ...
  const posts = async()=>{
    ...
    const allPosts = await fetch('https://commune1.onrender.com/myPost',{method:'post',headers:{'Content-Type':'application/json'},body:JSON.stringify(curuser)})
