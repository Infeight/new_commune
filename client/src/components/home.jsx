...
const showfollowers = ()=>{
  ...
  const posts = async()=>{
    ...
    const profilepics = await fetch('https://commune1.onrender.com/profilepics',{headers:{accept:'application/json'}})
    const likedposts = await fetch('https://commune1.onrender.com/likedposts',{headers:{accept:'application/json'}})
    const user_id = await fetch('https://commune1.onrender.com/user_id',{headers:{accept:'application/json'}})
